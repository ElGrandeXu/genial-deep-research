...
export const PROVIDER_INSTRUCTIONS = [
    ...
    "Commence par une recherche du nom exact, puis complète si nécessaire avec le contexte fourni et enfin avec une entreprise, un secteur, une ville ou une source d’identité détectée. Pour une entreprise, complète avec la ville, le secteur, les dirigeants, l’activité, les chiffres ou l’actualité. Reste dans un petit nombre borné de requêtes utiles.",
