...
export const PROVIDER_INSTRUCTIONS = [
    ...
    "Commence par les pages officielles d’organisation, d’équipe, à-propos, presse ou mentions légales suggérées par le nom et le contexte. Ne conclus pas à l’insuffisance avant d’avoir inspecté les pages primaires pertinentes proposées par Web Search.",
